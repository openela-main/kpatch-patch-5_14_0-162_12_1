...
Source104: CVE-2022-4744.patch
#
# https://bugzilla.redhat.com/2163415
Source105: CVE-2023-0266.patch
#
# https://bugzilla.redhat.com/2165362
Source106: CVE-2023-0386.patch
...
%changelog
* Mon Mar 27 2023 Yannick Cote <ycote@redhat.com> [1-3.el9_1]
- kernel: FUSE filesystem low-privileged user privileges escalation [2165362] {CVE-2023-0386}

* Sat Mar 18 2023 Yannick Cote <ycote@redhat.com> [1-2.el9_1]
